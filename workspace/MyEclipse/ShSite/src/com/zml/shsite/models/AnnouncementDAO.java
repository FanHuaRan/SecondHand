...
public class AnnouncementDAO extends HibernateDaoSupport {
	...
	public Announcement findById(java.lang.Integer id) {
		...
		try {
			Announcement instance = (Announcement) getHibernateTemplate().get("com.zml.shsite.models.Announcement", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Announcement instance with property: " + propertyName + ", value: " + value);
		try {
			String queryString = "from Announcement as model where model." + propertyName + "= ?";
	...
	public Announcement merge(Announcement detachedInstance) {
		...
		try {
			Announcement result = (Announcement) getHibernateTemplate().merge(detachedInstance);
