...
<body>
	...
	<div class="row" id="main">
		...
		<div class="container col-lg-10">
			<h3></h3>
			<form method="post" action="/ShSite/GoodManager/Edit" enctype="multipart/form-data"
                ...
                <div class="row">
	                ...
	                <div class="col-md-4" id="right">
                    		...
                    		<div class="form-group">
		                        ...
		                        <div class="col-lg-6">
		                           <select class="form-control" name="ShUserId" value="${good.getShUserId()}"
		                             data-bv-notempty data-bv-notempty-message="发布用户不能够为空" >
		                                <c:forEach items="${users}" var="user">
		                                	<c:if test="${good.getShUserId()==user.getShUserId()}">
		                                		 <option value="${user.getShUserId()}" selected="selected">${user.getShUserName()}</option>
		                                	</c:if>
		                                	<c:if test="${good.getShUserId()!=user.getShUserId()}">
		                                		 <option value="${user.getShUserId()}">${user.getShUserName()}</option>
		                                	</c:if>
		                                </c:forEach>
                          	 	   </select>
		                        </div>
