...
<body>
	...
	<div class="row" id="main">
		...
		<div class="container col-lg-10">
			<h3></h3>
			<form method="post" action="/ShSite/GoodManager/Create" enctype="multipart/form-data"
                ...
                <div class="row">
	                ...
	                <div class="col-md-4" id="right">
                    		<div class="form-group">
		                        ...
		                        <div class="col-lg-6">
		                           <select class="form-control" name="ShUserId"
	                        ...
	                        <div class="form-group">
		                        ...
		                        <div class="col-lg-6">
		                            <textarea name="Description" style="height:100px;width:400px;" type="text" class="form-control"
		                            		 ...
		                            		 data-bv-stringlength="true" data-bv-stringlength-min="5" data-bv-stringlength-max="50" data-bv-stringlength-message="商品描述必须保证在5到50个字符"></textarea>
		                        </div>
		                    </div>
